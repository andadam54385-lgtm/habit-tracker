...
export const CATALOGUE = [
  ...
  f("avoine", "Flocons d'avoine", "feculents", "g", 100,
    { kcal: 380, prot: 13, glu: 60, lip: 7, k: 350, mg: 140, ca: 54, fe: 4, zn: 3, b9: 32, se: 28 }),
  f("riz-blanc", "Riz blanc cuit", "feculents", "g", 100,
    { kcal: 130, prot: 2.7, glu: 28, lip: 0.3, k: 35, mg: 12, fe: 0.2, zn: 0.6, b9: 3 }),
  f("riz-complet", "Riz complet cuit", "feculents", "g", 100,
    { kcal: 123, prot: 2.7, glu: 26, lip: 1, k: 43, mg: 39, fe: 0.5, zn: 0.7, se: 6 }),
  f("pates", "Pâtes cuites", "feculents", "g", 100,
    { kcal: 145, prot: 5, glu: 28.5, lip: 0.9, k: 44, mg: 18, fe: 0.5, zn: 0.7, b9: 7, se: 15 }),
  f("pomme-de-terre", "Pomme de terre cuite", "feculents", "g", 100,
    { kcal: 87, prot: 2, glu: 20, lip: 0.1, k: 420, na: 6, mg: 23, ca: 10, fe: 0.8, zn: 0.3, c: 9.6, b9: 18 }),
  f("patate-douce", "Patate douce cuite", "feculents", "g", 100,
    { kcal: 90, prot: 2, glu: 21, lip: 0.1, k: 475, mg: 27, ca: 38, fe: 0.7, c: 20, b9: 6 }),
  ...
  f("semoule", "Semoule / couscous cuit", "feculents", "g", 100,
    { kcal: 112, prot: 3.8, glu: 23, lip: 0.2, k: 55, mg: 8, fe: 0.3, zn: 0.3, b9: 15, se: 27 }),
  f("lentilles", "Lentilles cuites", "feculents", "g", 100,
    { kcal: 116, prot: 9, glu: 20, lip: 0.4, k: 370, mg: 36, ca: 19, fe: 3.3, zn: 1.3, b9: 181, se: 3 }),
  f("pois-chiches", "Pois chiches cuits", "feculents", "g", 100,
    { kcal: 164, prot: 8.9, glu: 27, lip: 2.6, k: 291, mg: 48, ca: 49, fe: 2.9, zn: 1.5, b9: 172, se: 4 }),
  f("quinoa", "Quinoa cuit", "feculents", "g", 100,
    { kcal: 120, prot: 4.4, glu: 21, lip: 1.9, k: 172, mg: 64, ca: 17, fe: 1.5, zn: 1.1, b9: 42, se: 3 }),
  ...
  f("mozzarella", "Mozzarella", "laitiers", "g", 100,
    { kcal: 280, prot: 22, glu: 2, lip: 20, na: 600, ca: 500, mg: 20, zn: 2.9, b12: 1.5 }),

  // --------------------------------------------------------- légumes
  f("courgette", "Courgette", "legumes", "g", 100,
    { kcal: 17, prot: 1.2, glu: 3.1, lip: 0.3, k: 260, mg: 18, ca: 16, fe: 0.4, c: 17, b9: 24 }),
  ...
  f("tomate", "Tomate", "legumes", "g", 100,
    { kcal: 18, prot: 0.9, glu: 3.9, lip: 0.2, k: 237, mg: 11, ca: 10, fe: 0.3, c: 14, b9: 15 }),
  f("haricots-verts", "Haricots verts", "legumes", "g", 100,
    { kcal: 31, prot: 1.8, glu: 7, lip: 0.1, k: 211, mg: 25, ca: 37, fe: 1, c: 12, b9: 33 }),
  f("poivron", "Poivron", "legumes", "g", 100,
    { kcal: 31, prot: 1, glu: 6, lip: 0.3, k: 211, mg: 12, ca: 7, fe: 0.4, c: 128, b9: 46 }),
  f("salade", "Salade verte", "legumes", "g", 100,
    { kcal: 15, prot: 1.4, glu: 2.9, lip: 0.2, k: 194, mg: 13, ca: 36, fe: 0.9, c: 9, b9: 38 }),
  f("champignons", "Champignons", "legumes", "g", 100,
    { kcal: 22, prot: 3.1, glu: 3.3, lip: 0.3, k: 318, mg: 9, fe: 0.5, zn: 0.5, b9: 17, se: 9, d: 0.2 }),
  ...
  f("banane", "Banane", "fruits", "g", 100,
    { kcal: 89, prot: 1.1, glu: 23, lip: 0.3, k: 358, mg: 27, ca: 5, fe: 0.3, zn: 0.2, c: 8.7, b9: 20 }),
  f("pomme", "Pomme", "fruits", "g", 100,
    { kcal: 52, prot: 0.3, glu: 14, lip: 0.2, k: 107, mg: 5, ca: 6, c: 4.6, b9: 3 }),
  f("orange", "Orange", "fruits", "g", 100,
    { kcal: 47, prot: 0.9, glu: 12, lip: 0.1, k: 181, mg: 10, ca: 40, c: 53, b9: 30 }),
  f("kiwi", "Kiwi", "fruits", "g", 100,
    { kcal: 61, prot: 1.1, glu: 15, lip: 0.5, k: 312, mg: 17, ca: 34, c: 93, b9: 25 }),
  f("fraises", "Fraises", "fruits", "g", 100,
    { kcal: 32, prot: 0.7, glu: 7.7, lip: 0.3, k: 153, mg: 13, ca: 16, c: 59, b9: 24 }),
  f("avocat", "Avocat", "fruits", "g", 100,
    { kcal: 160, prot: 2, glu: 8.5, lip: 15, k: 485, mg: 29, ca: 12, fe: 0.6, zn: 0.6, c: 10, b9: 81 }),
  f("raisin", "Raisin", "fruits", "g", 100,
    { kcal: 69, prot: 0.7, glu: 18, lip: 0.2, k: 191, mg: 7, ca: 10, c: 3.2, b9: 2 }),

  // ---------------------------------------------------- noix & graines
  f("amandes", "Amandes", "noix", "g", 100,
    { kcal: 579, prot: 21, glu: 22, lip: 50, k: 733, mg: 270, ca: 269, fe: 3.7, zn: 3.1, b9: 44, se: 4 }),
  f("puree-amande", "Purée d'amande", "noix", "g", 100,
    { kcal: 614, prot: 21, glu: 19, lip: 56, k: 748, mg: 279, ca: 347, fe: 3.5, zn: 3.2, b9: 50 }),
  f("noix-bresil", "Noix du Brésil", "noix", "g", 100,
    { kcal: 659, prot: 14, glu: 12, lip: 67, k: 659, mg: 376, ca: 160, fe: 2.4, zn: 4.1, se: 1917 },
    { warnPer: 12, warnText: "Au-delà de ~12 g (2 noix), le sélénium dépasse la dose sûre." }),
  f("noix", "Noix", "noix", "g", 100,
    { kcal: 654, prot: 15, glu: 14, lip: 65, k: 441, mg: 158, ca: 98, fe: 2.9, zn: 3.1, b9: 98, om3: 9000 }),
  ...
  f("graines-courge", "Graines de courge", "noix", "g", 100,
    { kcal: 559, prot: 30, glu: 11, lip: 49, k: 809, mg: 592, ca: 46, fe: 8.8, zn: 7.8, b9: 58, se: 9 }),

  // ------------------------------------------------- matières grasses
  f("huile-olive", "Huile d'olive", "grasses", "ml", 100,
    { kcal: 884, prot: 0, glu: 0, lip: 100 }, { step: 10 }),
  f("beurre", "Beurre", "grasses", "g", 100,
    { kcal: 717, prot: 0.9, glu: 0.1, lip: 81, na: 11, ca: 24, d: 1.5 }, { step: 5 }),
  f("creme", "Crème fraîche 30 %", "grasses", "g", 100,
    { kcal: 290, prot: 2.4, glu: 3, lip: 30, k: 90, ca: 80 }),
  ...
  f("jus-orange", "Jus d'orange", "boissons", "ml", 100,
    { kcal: 45, prot: 0.7, glu: 10, lip: 0.2, k: 200, mg: 11, ca: 11, c: 50, b9: 30 }),
  f("jus-citron", "Jus de citron", "boissons", "ml", 100,
    { kcal: 22, prot: 0.4, glu: 6.9, lip: 0.2, k: 103, mg: 6, ca: 6, c: 38 }, { step: 10 }),
  ...
  f("miel", "Miel", "divers", "g", 100,
    { kcal: 304, prot: 0.3, glu: 82, lip: 0, k: 52 }, { step: 5 }),
  f("chocolat-noir", "Chocolat noir 70 %", "divers", "g", 100,
    { kcal: 598, prot: 7.8, glu: 46, lip: 43, k: 715, mg: 228, ca: 73, fe: 11.9, zn: 3.3 }),
