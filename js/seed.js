...
export const SEED_ITEMS = [
  ...
  it({ id: "diete-repas-1", section: "diete", group: "Journée type", title: "7 h, maison", detail: "3 œufs + 80 g avoine + banane + purée d'amande", recurrence: daily }),
  it({ id: "diete-repas-2", section: "diete", group: "Journée type", title: "Sac", detail: "Lait entier 500 ml, amandes, fruits", recurrence: daily }),
  it({ id: "diete-repas-3", section: "diete", group: "Journée type", title: "Pause", detail: "Salade de riz ou boulettes ou wrap", recurrence: daily }),
  it({ id: "diete-repas-4", section: "diete", group: "Journée type", title: "18 h, maison", detail: "Viande ou poisson + riz/pâtes + julienne + huile d'olive", recurrence: daily }),
  it({ id: "diete-repas-5", section: "diete", group: "Journée type", title: "Avant de dormir", detail: "400 ml lait entier", recurrence: daily }),

  it({ id: "diete-add-oeufs", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Œufs entiers, 3/jour", recurrence: daily }),
  it({ id: "diete-add-boeuf", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Bœuf 5-15 %, 2-3×/semaine", detail: "Absent depuis longtemps.", recurrence: week(2) }),
  it({ id: "diete-add-poisson", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Sardines ou maquereau, 2×/semaine", recurrence: week(2) }),
  it({ id: "diete-add-patates", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Pommes de terre", detail: "Meilleure source de potassium — remplace une partie du riz.", recurrence: week(4) }),
  it({ id: "diete-add-julienne", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Julienne de légumes (courgette, carotte)", recurrence: week(4) }),
  it({ id: "diete-add-avocat", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Avocat, 1/jour", recurrence: daily }),
  it({ id: "diete-add-bresil", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Noix du Brésil — 2/jour, jamais plus", warn: "Jamais plus de 2 par jour (sélénium).", recurrence: daily }),
  it({ id: "diete-add-fruits", section: "diete", group: "À ajouter à l'alimentation actuelle", title: "Fruits, 2/jour", recurrence: daily }),
  ...
  it({ id: "diete-boisson-jour", section: "diete", group: "Boissons", title: "Boisson de journée", detail: "1 L eau + 500 ml eau de coco + ¾ c. à café de sel + jus d'un citron", recurrence: daily }),
  it({ id: "diete-boisson-presalle", section: "diete", group: "Boissons", title: "Pré-salle, 2-3 h avant", detail: "300 g betterave crue + 2 carottes + citron + gingembre — 2-3×/semaine", recurrence: week(2) }),
  it({ id: "diete-boisson-post", section: "diete", group: "Boissons", title: "Post-training : jus de grenade 200-250 ml", detail: "Jours d'entraînement uniquement.", recurrence: week(2) }),
  it({
