...
export function viewSections() {
  ...
  html += '<div class="section-links">' +
    '<a class="row-link" href="#/objectifs">🎯 Objectifs de la semaine et du mois</a>' +
...
export function viewSection(key, subKey) {
  ...
  if (key === "routine" || key === "relaxation") {
    html += '<a class="callout" href="#/routine">' +
      "<strong>🧘 Routines guidées chronométrées</strong>" +
      "<span>Ouvrir →</span></a>";
  }
