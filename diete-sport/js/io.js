...
// Taux de réussite pour l'export Markdown — repris d'objectives.js (App
// "Objectifs & Routine" seulement) : cette app n'a pas ce module, mais
// exportMarkdown() en a besoin pour sa section "Réussite".
function weekStartAt(offset) {
...
function computeRate(item, dates) {
...
function computeTotalRate(items, dates) {
  const applicable = dates.filter((d) => !isFuture(d));
